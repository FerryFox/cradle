...
import {Divider, FormControl, FormHelperText, InputLabel, MenuItem, Select, SelectChangeEvent, Toolbar} from "@mui/material";

// @ts-ignore
import {resizeAndCropImage} from "../../../assets/picture/resizeAndCropImage.ts";
    ...
    <Box sx={{marginTop: 3, display: 'flex', flexDirection: 'column', alignItems: 'center',}}>
        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 , mb : 2}}>
            ...
            <TextField margin="normal" required fullWidth
                       ...
                       onChange ={e  =>
                           setNewTemplate((newTemplate: NewTemplate) =>({...newTemplate, name : e.target.value}))}
            ...
            <TextField margin="normal" required fullWidth sx={{ marginBottom: 2 }}
                       ...
                       onChange ={e  =>
                           setNewTemplate((newTemplate : NewTemplate) =>({...newTemplate, promise : e.target.value}))}
            ...
            <TextField margin="normal" required fullWidth sx={{ marginBottom: 2 }}
                       ...
                       onChange ={e  =>
                           setNewTemplate((newTemplate : NewTemplate) =>({...newTemplate, description : e.target.value}))}
            ...
            <TextField margin="normal" required fullWidth sx={{ marginBottom: 2 }}
                ...
                value={newTemplate.defaultCount}
                       onChange={e =>
                           setNewTemplate( (newTemplate : NewTemplate) => ({
                               ...newTemplate,
